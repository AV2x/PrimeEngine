    ...
    <div class="col-md-6">
        ...
        <form action="{{route('services.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                ...
                <select class="form-select" required id="inputGroupSelect01" name="category_id">
            ...
            <div id="prices">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="price" placeholder="4000" class="form-control" aria-label="Цена" aria-describedby="inputGroup-sizing-default">
                </div>
            </div>
            <hr>
            <div id="options">
                ...
                <div class="input-group mb-3" id="option_0">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="options[0][name]" placeholder="Объем двигателя" class="form-control" aria-label="Название характеристики" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="col-md-6">
                            <span class="input-group-text">Значение</span>
                            <input type="text" name="options[0][value]" placeholder="2.4л" class="form-control" aria-label="Название характеристики" aria-describedby="inputGroup-sizing-default">
                        </div>
    ...
    <script>
        ...
        function addOptions()
        {
           ...
           var html = '<div class="input-group mb-3" id="option_'+i+'">'+
               ...
               '<div class="col-md-6">'+
               '<span class="input-group-text">Название</span>'+
               '<input type="text" name="options['+i+'][name]" placeholder="Объем двигателя" class="form-control" aria-label="Название характеристики" aria-describedby="inputGroup-sizing-default">'+
               '</div>'+
               '<div class="col-md-6">'+
               '  <span class="input-group-text">Значение</span>'+
               ' <input type="text" name="options['+i+'][value]" placeholder="2.4л" class="form-control" aria-label="Название характеристики" aria-describedby="inputGroup-sizing-default">'+
               ' </div>'+
               '</div>'+
               '<div class="row">'+
